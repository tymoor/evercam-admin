    ...
    markers =
      ...
      |> Enum.reduce([], fn camera, acc ->
        ...
        marker = %{
          ...
          status: status_peg(camera.is_online)
        }
        acc ++ [marker]
      end)
  ...
  defp add_template(camera) do
    "<table class='table order-column'>\
      ...
      <tr>\
        ...
        <tr>\
          <th>Online ?</th>\
          <td>#{humanize_status(camera.is_online)}</td>\
        </tr>\
        <tr>\
          <th>Public ?</th>\
